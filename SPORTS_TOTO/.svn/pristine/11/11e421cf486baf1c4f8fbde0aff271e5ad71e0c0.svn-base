...
<%
	...
	int totalpage=dao.noticeFindTotalPage(fs,ss);
	List<NoticeVO> find=dao.noticeFindData(fs,ss,curpage);
		...
		<%
			if(find.size()==0){
				...
				<table id="table_content2" width="1100">
					<tr>
						<td align="center" style="border-top-left-radius: 1em; border-top-right-radius: 1em;">
							<h2>검색 결과</h2>
						</td>
					</tr>
					<tr height="600">
